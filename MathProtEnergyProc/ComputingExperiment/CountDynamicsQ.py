...
class ModelLearningQ(object):
    ...
    def ModelLearning(self,cTints,
        ...
        comExpRez = self.__CountDynamicsQ.ComputingExperimentQ(cTints,
                                                               cStateCoordinates0,
                                                               cReducedTemp0,
                                                               cSystemParameters,
                                                               t_evals = ct_evals)
