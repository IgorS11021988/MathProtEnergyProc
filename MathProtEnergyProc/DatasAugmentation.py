...
def GenerateRandomdatasInDiapasons(minValues,#Минимальные значения величин
    ...
    #Приводим числа точек к массиву numpy
    aNPoints = np.array(nPoints)#Приводим массив точек к numpy массиву
...
def HStackMatrixRepeatTwo(values1,#Величины 1
    ...
    isNeedConcatValuesIndexes = not concatValuesIndexesList is None
...
def HStackMatrixRepeat(listValues,#Список массивов данных величин
    ...
    if not concatValuesIndexes is None:
