...
class NonEqSystemQBase:
    ...
    def __init__(self,
        ...
        self.__TEnergyPowers = NonEqSystemQBase.__Tbase*np.ones((nEnergyPowers,), dtype=np.double)
    ...
    @staticmethod
    def GetTbase():
        return NonEqSystemQBase.__Tbase
    ...
    def CountSystem(self,
        ...
        invTEnergyPowers = NonEqSystemQBase.__Tbase / self.__TEnergyPowers#Приведенные температуры
