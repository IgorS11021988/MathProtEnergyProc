...
# Модульные тесты
class TestNonEqSystem(unittest.TestCase):
    def setUp(self):
    ...
    def testNonEq1(self):
        ...
        (chemPot, Aff, kineticMatrix,
         vProcesses, balanceMatrix, vx) = CountSystem1(stateCoordinates, systemParameters,
        ...
        self.assertEqual(kineticMatrix.tolist(), nonEqSystem.GetKineticMatrix().tolist())  # Проверяем главный блок кинетической матрицы
    ...
    def testNonEq4(self):
        ...
        (chemPot, Aff, kineticMatrix, vProcesses,
         balanceMatrix, vx, Streams) = CountSystem2(stateCoordinates, systemParameters,
                                                    nu1_1, nu1_2, nu1_3, nu1_4, nu1_5, nu1_6, nu1_7,
    ...
    def testNonEq5(self):
        ...
        systemParameters = [10, 20, 50, 70, 100, 200, 1, 55, 10, 25, 35, 55, 75, 81, 210, 300, 160, 173, 123, 15.3, 43.9, 5.63, 10, 6.5, 45.4, 315, 21.3, 4.5, 1.5, 33.9, 27.3, 4.43, 21.9, 7.5, 52.6, 21.9, 45.3, 33.9, 139, 21.9, 1.5, 7.53, 36.5, 1.5, 120.3, 74.5, 15.3, 21.3, 0.15, 74.1]  # Параметры системы
    ...
    def testNonEq7(self):
        ...
        # Эталонный результат
        (chemPot, Aff, kineticMatrix, vProcesses,
         balanceMatrix, vx) = CountSystem3(stateCoordinates, systemParameters,
