...
# Модульные тесты
class TestNonEqSystemComExp(unittest.TestCase):
    def setUp(self):
    ...
    def testNonEqDyns1(self):
        ...
        systemParameters1 = np.array([10, 20, 50, 70, 100, 200, 30, 45, 10, 25, 35, 55, 75, 81, 210, 300, 150, 153, 123, 15.3, 45.9, 5.63, 10, 6.5, 45.4, 315, 21.3, 4.5, 1.5, 33.9, 27.3, 4.53, 21.9, 7.5, 53.6, 21.9, 45.3, 33.9, 159, 21.9, 43.5, 7.53, 37.5, 1.5, 120.3])  # Параметры системы
        stateCoordinates2 = np.array([11, 23, 45, 75, 141, 113, 39, 95, 83, 73])  # Координаты состояния
        systemParameters2 = np.array([10, 20, 50, 70, 100, 200, 30, 45, 10, 25, 35, 54, 75, 81, 210, 300, 153, 153, 123, 15.3, 45.9, 5.43, 10, 6.5, 45.4, 315, 21.3, 4.83, 1.5, 33.9, 27.3, 4.53, 21.9, 7.5, 52.6, 22.9, 45.3, 33.9, 159, 21.9, 43.5, 7.53, 37.5, 1.5, 120.3])  # Параметры системы
        stateCoordinates3 = np.array([34, 20, 55, 75, 411, 213, 39, 55, 93, 81])  # Координаты состояния
        systemParameters3 = np.array([10, 20, 51, 70, 100, 200, 30, 45, 10, 25, 35, 55, 85, 81, 210, 300, 150, 153, 123, 15.3, 45.9, 5.63, 10, 6.5, 45.4, 615, 21.3, 4.5, 1.5, 33.9, 21.3, 4.53, 21.9, 7.5, 53.6, 21.9, 45.3, 33.9, 159, 21.9, 43.5, 7.53, 37.5, 1.5, 120.3])  # Параметры системы
        ...
        Tints = np.array([Tint,
                          Tint])
        dyns = cDyn.ComputingExperiment(Tints,
                                        stateCoordinates,
                                        systemParameters,
                                        t_evals=t_evals)
    ...
    def testNonEqDyns2(self):
        ...
        t_eval2 = np.linspace(0.0, Tint2,  7000)
    ...
    def testNonEqDyns3(self):
        ...
        stateCoordinatesEt = integ.solve_ivp(countSystem1_3,
                                             (0.0, Tint),
                                             stateCoordinates1,  # Начальное состояниесостояние
                                             atol=atol,
                                             rtol=rtol,
                                             max_step=max_step,
                                             method=method  # Метод численного интегрирования
        ...
        # Рассчитываем динамику параметров системы
        stateCoordinates = stateCoordinates1.reshape(1, -1)
        systemParameters = np.vstack([systemParameters1,
                                      systemParameters2,
                                      systemParameters3])
        Tints = np.array([Tint,
    ...
    def testNonEqDyns4(self):
        # Исходные данные
        stateCoordinates1 = np.array([14, 20, 55, 75, 111, 217, 29, 45, 96, 81, 80, 64])  # Координаты состояния
        systemParameters1 = np.array([10, 20, 50, 70, 100, 200, 30, 45, 10, 25, 35, 55, 75, 71, 210, 300, 160, 153, 123, 15.3, 45.9, 5.63, 10, 6.5, 45.4, 315, 21.3, 4.5, 1.7, 33.9, 23.3, 4.53, 21.9, 3.5, 53.6, 24.9, 45.3, 36.9, 159, 21.9, 43.5, 7.53, 37.5, 1.5, 120.3, 73.5, 15.3, 21.3, 0.15, 74.1])  # Параметры системы
        stateCoordinates2 = np.array([10, 22, 55, 75, 111, 213, 39, 35, 93, 11, 10, 34])  # Координаты состояния
        systemParameters2 = np.array([10, 20, 50, 70, 100, 200, 30, 45, 10, 25, 35, 25, 75, 81, 210, 300, 150, 153, 123, 15.3, 45.9, 5.63, 10, 6.5, 41.4, 315, 21.3, 4.5, 1.5, 33.9, 27.3, 4.53, 21.9, 7.5, 53.6, 21.9, 45.3, 33.9, 159, 21.9, 43.5, 7.53, 37.5, 1.5, 121.3, 73.5, 15.3, 21.3, 0.15, 74.1])  # Параметры системы
        stateCoordinates3 = np.array([10, 20, 55, 75, 121, 213, 39, 45, 97, 81, 83, 64])  # Координаты состояния
        systemParameters3 = np.array([10, 20, 50, 70, 100, 200, 30, 45, 10, 25, 35, 55, 74, 81, 210, 300, 150, 153, 123, 15.3, 45.9, 5.63, 10, 6.5, 45.4, 615, 21.3, 4.5, 1.5, 33.9, 27.5, 4.53, 21.9, 7.5, 53.6, 21.9, 45.3, 31.9, 159, 21.9, 43.5, 7.53, 37.5, 1.5, 120.3, 73.5, 15.3, 21.3, 0.15, 74.1])  # Параметры системы
        stateCoordinates4 = np.array([10, 23, 55, 75, 111, 213, 39, 47, 93, 81, 82, 64])  # Координаты состояния
        systemParameters4 = np.array([10, 20, 50, 70, 100, 200, 30, 45, 10, 25, 35, 55, 75, 81, 210, 300, 151, 153, 123, 15.3, 45.9, 5.63, 10, 6.5, 41.4, 315, 21.3, 4.5, 1.5, 33.9, 22.3, 5.53, 21.9, 7.5, 53.6, 21.9, 45.3, 33.9, 149, 21.9, 43.5, 7.53, 37.5, 1.5, 120.3, 73.5, 11.3, 21.3, 0.15, 74.1])  # Параметры системы
    ...
    def testNonEqDyns5(self):
        ...
        # Моменты времени
        t_eval1 = np.linspace(0.0, Tint1, 10000)
        t_eval2 = np.linspace(0.0, Tint2,  9000)
        t_eval3 = np.linspace(0.0, Tint3, 15000)
        ...
        self.assertTrue(char3.shape == char3et.shape)
        self.assertTrue(np.all(ind == indsEt))
        self.assertTrue(np.all(ind.shape == indsEt.shape))

    def testNonEqDyns6(self):
        # Исходные данные
        stateCoordinates1 = np.array([14, 20, 55, 75, 111, 217, 29, 45, 96, 81, 80, 64])  # Координаты состояния
        systemParameters1 = np.array([10, 20, 50, 70, 100, 200, 30, 45, 10,  25, 35, 55, 75, 71, 210, 300, 160, 153, 123, 15.3, 45.9, 5.63, 10, 6.5, 45.4, 315, 21.3, 4.5, 1.7, 33.9, 23.3, 4.53, 21.9, 3.5, 53.6, 24.9, 45.3, 36.9, 159, 21.9, 43.5, 7.53, 37.5, 1.5, 120.3, 73.5, 15.3, 21.3, 0.15, 74.1])  # Параметры системы
        stateCoordinates2 = np.array([10, 22, 55, 75, 111, 213, 39, 35, 93, 11, 10, 34])  # Координаты состояния
        ...
        # Рассчитываем эталонную динамику системы
        (atol, rtol, max_step) = funIntegAttributes(systemParameters4, method)
        stateCoordinatesEt = integ.solve_ivp(countSystem2_4,
                                             (0.0, Tint),
                                             stateCoordinates2,  # Начальное состояние
                                             atol=atol,
    ...
    def testNonEqDyns7(self):
        # Исходные данные
        stateCoordinates1 = np.array([10, 22, 54, 75, 117, 211])  # Координаты состояния
        systemParameters1 = np.array([10, 20, 50, 70, 101, 200, 30, 47, 10, 25, 35, 55, 75, 82, 210, 300, 150, 153, 123, 15.3, 45.9, 5.63, 10, 6.5, 45.4, 315, 181])  # Параметры системы
        stateCoordinates2 = np.array([10, 20, 55, 75, 111, 213])  # Координаты состояния
        systemParameters2 = np.array([10, 20, 50, 70, 100, 200, 30, 45, 10, 25, 35, 55, 75, 81, 210, 300, 150, 153, 123, 15.3, 45.9, 5.63, 10, 6.5, 45.4, 315, 161])  # Параметры системы
    ...
    def testNonEqDyns8(self):
        ...
        # Функция аттрибутов интешгрирования
        def funIntegAttributes(systemParameters, method):
            # Определяем аттрибуты
        ...
        # Моменты времени
        t_eval1 = np.linspace(0.0, Tint1, 10000)
        t_eval2 = np.linspace(0.0, Tint2, 10500)
