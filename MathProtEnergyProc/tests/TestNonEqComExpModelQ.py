...
class TestNonEqSystemComExpModelQ(unittest.TestCase):
    ...
    def testNonEqDyn2(self):
        ...
        reducedTemp2 = np.array([350, 423])  # Приведенные температуры энергетических степеней свободы
        systemParameters2 = systemParameters = np.array([0.3, 0.7, 10, 20, 50, 70, 100, 200, 30, 45, 10, 25, 35, 55, 75, 81, 210, 300, 150, 153, 23, 15.3, 45.9, 5.63, 10, 6.5, 45.4, 315, 21.3, 4.5, 1.5, 36.9, 27.6, 4.53, 21.5, 7.5, 53.6, 21.9, 45.3, 33.9, 159, 21.9, 43.5, 7.53, 37.5, 1.5, 120.3, 73.5, 15.3, 21.3, 0.15, 74.1, 81.0, 5.13, 31.8, 3.3, 39.63, 54.3, 27.3, 0.15, 0.15])  # Параметры системы
