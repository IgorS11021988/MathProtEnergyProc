...
from MathProtEnergyProc.DatasAugmentation import ComputingExperimentBegDatasAugmentation

import unittest


# Модульные тесты
class TestComputingExperimentBegDatasAugmentation(unittest.TestCase):
    def setUp(self):
    ...
    # Модульные тесты
    def testComputingExperimentBegDatasAugmentation1(self):
        # Исходные данные
        ...
        randomParametersValues = [[4.1, 3.2, 6.5],
                                  [8.3, 4.3, 8.5],
                                  [6.7, 5.1, 6.3]]
        parametersState0Indexes = [0, 2, 3, 5]
        ...
        matrValuesRez = ComputingExperimentBegDatasAugmentation(settingParametersValues,  # Значения задаваемых параметров системы
        ...
        dMatrValuesRez = np.max(np.abs(matrValuesRez[1] - matrValuesRezEt[:, systemParametersIndexes]))
        self.assertEqual(dMatrValuesRez, 0.0)

    def testComputingExperimentBegDatasAugmentation2(self):
        # Исходные данные
        ...
        randomParametersValues = [[3.1, 3.2, 6.5, 4.5, 5.6],
                                  [8.3, 2.3, 8.5, 1.1, 7.7]]
        parametersState0Indexes = [0, 3, 6, 2]
    ...
    def testComputingExperimentBegDatasAugmentation3(self):
        # Исходные данные
